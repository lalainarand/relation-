<?php
    ...
    if(isset($_POST['libelle'])){
        echo "test";
        $categorie = $obj->insert('categories',$_POST);
        if($categorie){
            header('Location: index.php');
        }
    }

    $categories = $obj->select('categories','*',null,null,null,null);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="libelle" id="nom" class="form-control" placeholder="" aria-describedby="helpId">
